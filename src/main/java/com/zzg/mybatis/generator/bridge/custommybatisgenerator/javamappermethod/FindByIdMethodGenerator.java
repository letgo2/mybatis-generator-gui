...
/**
 * @Description 自定义dao的公共文件的通过id查找的方法
 * @author      dfg
 * @since       2019/11/5 14:03
 */
public class FindByIdMethodGenerator extends AbstractJavaMapperMethodGenerator {
    private boolean isSimple;

    public FindByIdMethodGenerator(boolean isSimple) {
        super();
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(CustomIntrospectedTable.findById);
