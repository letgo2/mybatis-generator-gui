...
/**
 * @Description 自定义dao文件的通过id删除的公共方法
 * @author      dfg
 * @since       2019/11/5 13:57
 */
public class DeleteByIdMethodGenerator extends AbstractJavaMapperMethodGenerator {
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(CustomIntrospectedTable.deleteById);
